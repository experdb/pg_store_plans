/*
 * pg_store_plans/pg_store_plans--1.10e1.sql
 *
 * Extension installation SQL script (version 1.10e1)
 *
 * - Create main functions and views
 * - Create pg_store_plans function with PostgreSQL version branching (17+/below)
 * - Grant permissions
 */
